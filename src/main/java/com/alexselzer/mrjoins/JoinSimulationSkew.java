...
public class JoinSimulationSkew {
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        results.println("rows,repetitions,reducers,skew,map_records,reduce_records,t_repartition,t_broadcast,t_merge_1_1,t_merge_1_2,t_merge_2_1,t_merge_2_2,t_merge_3,t_merge");
